...
class NIScenario(
    ...
    def __init__(
        ...
        :param percentage_exp_assignment: If not None, the pattern assignment
            to use. It must be a list with an entry for each experience. Each
            entry is a float representing the percentage of patterns to assign
            to that experience. Overrides ``balance_experiences``.
        ...
        if reproducibility_data or lst_fixed_exp_assignment:
            ...
            if balance_experiences and percentage_exp_assignment is None:
                ...
                # experience.
                # NOTE: the remaining patterns can be all of them.
                if shuffle:
                ...
                # If defined percentage_exp_assignment:
                # Distribute the remaining patterns according to the percentage_exp_assignment. 
                # This is a neat way of being able to combine min_class_patterns_in_exp and 
                # balance_experiences.
                if percentage_exp_assignment is not None:
                    if len(percentage_exp_assignment) != n_experiences:
                        raise ValueError(
                            "The number of percentages in percentage_exp_assignment"
                    ...
                    prev_idx = 0
                    for exp_id in range(n_experiences):
                        next_idx = prev_idx + n_patterns_per_exp[exp_id]
                ...
                else: # PREV CODE: equal distribution on all experiences
