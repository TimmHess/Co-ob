...
class CumulativeSelect(SupervisedTemplate):
    ...
    def __init__(
        ...
        *,
        ...
        cumulative_exps: Optional[List[int]],
        train_mb_size: int = 1,
        train_epochs: int = 1,
        ...
        **kwargs
        ...
        self.curr_exp = 0
        self.cumulative_exps = cumulative_exps
    ...
    def train_dataset_adaptation(self, **kwargs):
        ...
        if self.dataset is None:
            ...
            if strategy.clock.train_exp_counter in self.cumulative_exps:
