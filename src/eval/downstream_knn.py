...
class KNNClassifier():
    ...
    def __init__(self, k=5, use_inner_prduct=False):
        self.index = None
        self.y = None
        self.k = k
...
class DownstreamKNNAccuracyMetric(GenericPluginMetric[float, Accuracy]):
    def __init__(
        self, 
        args, 
        downstream_task, 
        ...
        super(DownstreamKNNAccuracyMetric, self).__init__(
